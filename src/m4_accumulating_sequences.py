...
def run_test_make_simple_string():
    ...
    actual = make_simple_string(97, 103)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2
    expected = '97-98-99-100-101-102-103'
    actual = make_less_simple_string(97, 103)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        top_left = rg.Point(center.x - radius, center.y - radius)
        bot_righ = rg.Point(center.x + radius, center.y + radius)
        rectangles += [rg.Rectangle(top_left, bot_righ)]
