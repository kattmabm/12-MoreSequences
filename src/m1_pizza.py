...
def run_test_draw_points_on_circle():
    ...
    title = 'DRAW_POINTS_ON_CIRCLE, test 1:  50 red dots.'
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    title = 'PIZZA test 4: a khjfjillion black slices on yellow circle.'
...
def run_test_polygon():
    ...
    title = 'POLYGON test 3: 5 segments with thin pink lines'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 5
    polygon(window, circle, 5, 'pink', 2)
    window.close_on_mouse_click()
